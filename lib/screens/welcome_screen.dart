...
import 'package:flutter/foundation.dart' show kDebugMode, kIsWeb; // Para kDebugMode y kIsWeb
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Image.asset(
                  ...
                  errorBuilder: (c, e, s) => const Icon(Icons.shield_outlined, size: 100, color: Colors.white70),
                ),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    style: ElevatedButton.styleFrom( // Estilo personalizado de fuente
                    ...
                    onPressed: () {
                      ...
                      _playClickSound();
                      AudioManager.instance.stopBackgroundMusic(); // Parar música anterior
                      tournamentProvider.resetTournament(); // Reiniciar datos del torneo
                      AudioManager.instance.playBackgroundMusic(); // Iniciar música nueva
                      // Navegar a la pantalla de registro
                      Navigator.push( context, MaterialPageRoute( builder: (context) => const RegisterParticipantsScreen()), );
                    },
                  ),
                ),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    style: ElevatedButton.styleFrom( // Estilo personalizado (color y fuente)
                    ...
                    onPressed: () {
                      ...
                      if (!kIsWeb) {
                         if (kDebugMode) print("Attempting SystemNavigator.pop()");
                        SystemNavigator.pop();
                      } else {
                         // En web, mostrar mensaje
                         if (kDebugMode) print("Cannot pop on web, showing SnackBar.");
                        ScaffoldMessenger.of(context).showSnackBar( const SnackBar( content: Text("Cierra la pestaña del navegador para salir.")), );
                      }
                    },
                  ),
                ),
