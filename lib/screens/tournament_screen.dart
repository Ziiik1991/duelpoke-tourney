...
class _TournamentScreenState extends State<TournamentScreen> {
  ...
  void _calculateLayout(List<List<Match>> rounds) {
    ...
    double verticalSpacing = _matchHeight + _baseVSpacingMultiplier * _matchHeight; 
    ...
    _totalBracketHeight = maxCalculatedHeight + _matchHeight;

    if (kDebugMode) {
      print("Layout Calculation Done (Fixed Minimal Spacing).");
      print("Total Bracket Width: $_totalBracketWidth");
      print("Total Bracket Height: $_totalBracketHeight"); 
