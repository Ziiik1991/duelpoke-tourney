...
class Match {
  ...
  final int matchIndexInRound; // Índice del partido dentro de su ronda (0, 1, 2...)
  ...
  bool get isBye => winnerId != null && (participant1 == null || participant2 == null || participant1?.id == winnerId || participant2?.id == winnerId);
